<div class="content-wrapper">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Benapole-Bhomra</li>
		</ol>
  		<div id="demo">
			<div class="step-app">
				<ul class="step-steps">
				...
				<div class="step-content">
					...
					<div class="step-tab-panel" id="step4">
						<div style="padding-top:10px;padding-bottom:10px;margin-top:10px;" class="col-md-12 form-custom2"  >
							...
							<table id="bvp" style="" class="table table-bordered text-center">
								...
								<tr>  
									<form class="com_add_form" method="POST">
										<td>
											Clearing Commission A/Value Tk 
										</td>
										<td > 
...
<script type="text/javascript">
	$(document).ready(function() {	
		...
		$('#reg-form2').submit(function(e){
			...
			$.ajax({
				url: 'extarnel_pages/submit_job_bv.php',
				type: 'POST',
				data: $(this).serialize() // it will serialize the form data
			})
			.done(function(data){
