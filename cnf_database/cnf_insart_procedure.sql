...
/* CALL insert_job('120/45',1999,2333,curdate(),'oil',900,40,'x.p padma','8989','992',curdate(),'343h343u','something','cc','port',49000.00,curdate(),10,1,@p_msg);SELECT @p_msg; */
